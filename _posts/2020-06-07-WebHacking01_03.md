...
<figure class="align-center">
  ...
  <figcaption> 그랬더니 주석 처리된 부분에 admin.php로 들어갖 말라는 일종의 경고 메세지가 쓰여있는게 눈에 띄었고 뒤늦게 발견했지만 맨위에는 시간 부분이 주석처리 되어있었다.</figcaption>
</figure> 

<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/WebHacking.kr/문제2/2-2.PNG" alt="">
  <figcaption> 혹시 몰라 이전에 받은 Edit This Cookie를 통해 쿠키를 살펴보니 time 이라는 쿠키를 볼 수 있었다. 이 쿠키에 아무 값이나 대입해보았다.<figcaption>
</figure> 

 <figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/WebHacking.kr/문제2/2-3.PNG" alt="">
  <figcaption> 그랬더니 주석처리된 시간 부분이 입력한 값 처럼 바뀌었다. 사진에는 없지만 True와 False를 입력했더니 1과 0이 출력되었다. True와 False를 반환하는 것을 보고 Blind SQL Injection을 생각할 수 있었고 다음 사진처럼 입력해보았다.<figcaption>
  </figure> 
