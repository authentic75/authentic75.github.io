...
2번 문제를 풀면서 시간이 생각보다 오래걸렸다. 웹해킹 공부를 좀더 한 후에는 좀더 빠르게 구할수 있는 방법으로 다시 풀어볼 생각이다.
이 문제를 통해서 True와 Flase를 반환하는 환경에서 Blind SQL Injection 취약점을 이용할 수 있다는 것을 알 수 있었다.
{: .notice}
